...
#### Must Knows
- Direct Connect can only be linked to up to 3 Transit Gateways

___
### Diagrams
#### Direct Connect with VLAN
![[Direct Connect with VLAN.png]]
#### Direct Connect Site Link
![[Direct Connect Site Link.png]]
#### Direct Connect High Availability
![[Direct Connect High Availability.png]]
